  ...
  return (
    <ScrollView style={styles.container}>
      ...
      {projects.map((project) => (
        <View key={project.id} style={styles.challengeCard}>
          <Text style={styles.challengeTitle}>{project.title}</Text>
          <Text style={styles.challengeDate}>Límite de postulación: {project.deadline}</Text>
          <Text style={styles.challengeDate}>Estado: {project.status}</Text>
        </View>
      ))}
    </ScrollView>
  );
